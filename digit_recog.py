...
#sys arg 1
TRAIN_DATA_IMG = r'F:\Python-Custom-Digit-Recognition-master\digits.png'

#sys arg 2
filename = sys.argv[1]
#USER_IMG = r'F:\Python-Custom-Digit-Recognition-master\test_image.png'
USER_IMG = filename
...
def get_digits(contours):
    ...
    for r in digit_rects:
        x,y,w,h = r
        if w^h > 10000 and x == 0 and y == 0: #big and window bounds
            print(r)
            rects_final.remove(r)    
